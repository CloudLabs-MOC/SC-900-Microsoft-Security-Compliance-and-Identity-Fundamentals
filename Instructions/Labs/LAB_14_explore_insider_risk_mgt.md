...
1. On **Sign in** blade, you will see a login screen, in that enter the following **email/username** and **password**. 
...
1. **Detection options:** Review the information,and leave everything as default and then select **Next**.   
