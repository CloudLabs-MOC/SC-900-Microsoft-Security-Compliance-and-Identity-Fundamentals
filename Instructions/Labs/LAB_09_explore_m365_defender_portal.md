...
1. The cards displayed can be customized to your preference.  Select **+ Add cards (1)**. A Window opens indicating that you already have all the cards on your home page.  Close the window by select the **X (2)** on top-right corner of the window.
